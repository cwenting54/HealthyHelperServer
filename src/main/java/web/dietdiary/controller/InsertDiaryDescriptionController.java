...
@WebServlet("/dietDiary/diaryDescription/insert")
public class InsertDiaryDescriptionController extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req,HttpServletResponse resp) throws IOException {
        ...
        affectedRows = this.diaryDescriptionService.insert(targetDiaryDescriptionVO);
        if(affectedRows != 1) {
