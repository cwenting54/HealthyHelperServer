...
@WebServlet("/dietDiary/diaryDescription/update")
public class UpdateDiaryDescriptionController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req,HttpServletResponse resp) throws IOException {
        ...
        String errorMessage = "";
        DiaryDescriptionVO diaryDescriptionVO = gson.fromJson(req.getReader(), DiaryDescriptionVO.class);
        
        int affectedRows = this.diaryDescriptionService.insert(diaryDescriptionVO);
        if(affectedRows != 1) {
